...
A powerful tool to scan IP address ranges and discover DNS servers that can be used with [`dnstt-client`](https://www.bamsoftware.com/software/dnstt/). This scanner helps you find working DNS resolvers that support the dnstt (DNS tunnel) protocol, including full SOCKS proxy functionality.
...
- **dnstt server public key** - Required for tunnel verification
- **Network access** - To scan DNS servers on port 53
...
- [dnstt](https://www.bamsoftware.com/software/dnstt/) - DNS tunnel implementation
